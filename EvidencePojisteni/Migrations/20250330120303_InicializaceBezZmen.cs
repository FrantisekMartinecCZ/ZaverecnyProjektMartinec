...
{
    /// <inheritdoc />
    public partial class InicializaceBezZmen : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    MusisZmenitHeslo = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdPojistence = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    JmenoZakonnehoZastupce = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PrijmeniZakonnehoZastupce = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Pohlavi = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Pojistenci", x => x.IdPojistence);
                    table.ForeignKey(
                        name: "FK_Pojistenci_AspNetUsers_UzivatelID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdPojisteni = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TypPojisteni = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    RolePojisteni = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Pojisteni", x => x.IdPojisteni);
                    table.ForeignKey(
                        name: "FK_Pojisteni_Pojistenci_PojistenecId",
                        column: x => x.PojistenecId,
                        principalTable: "Pojistenci",
                        principalColumn: "IdPojistence",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdPojistnaUdalost = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Popis = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    DatumUdalosti = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DatumNahlaseni = table.Column<DateTime>(type: "datetime2", nullable: true),
                    OdhadSkody = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Stav = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Poznamka = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    PojistenecId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PojistneUdalosti", x => x.IdPojistnaUdalost);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Pojistenci_UzivatelID",
                table: "Pojistenci",
                column: "UzivatelID",
                unique: true,
                filter: "[UzivatelID] IS NOT NULL");
